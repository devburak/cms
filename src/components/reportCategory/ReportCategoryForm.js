...
import { Autocomplete, Button, Divider, FormControlLabel, Grid, Switch, TextField } from '@mui/material';
...
export default function ReportCategoryForm({ selectedCategory, onSave, categories = [] }) {
        ...
        <Grid item xs={12} md={6}>
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                {...params}
                label="Bu modelde ust kategori yok"
                size="small"
                fullWidth
              />
            )}
